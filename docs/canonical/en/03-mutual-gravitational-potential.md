...
| Libration / instability time scale | $\sim 10^7\ \text{s}$ (~7–12 months; Earth- to Sun-tidal) | Integration window must be $\gg T_{\mathrm{lib}}$ to observe libration — not captured at $600\ \text{s}$ window |
